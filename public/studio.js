...
async function loadBrandConfig() {
  try {
    ...
    if (res.ok) {
      ...
      const cp = brand.colors?.primary || '#667eea';
      const cs = brand.colors?.secondary || '#764ba2';
      const ca = brand.colors?.accent || '#4caf50';
      document.getElementById('brand-color-primary').value = cp;
      document.getElementById('brand-color-primary-hex').value = cp;
      document.getElementById('brand-color-secondary').value = cs;
      document.getElementById('brand-color-secondary-hex').value = cs;
      document.getElementById('brand-color-accent').value = ca;
      document.getElementById('brand-color-accent-hex').value = ca;
